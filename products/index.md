...
## Roman SIT Annual Report (April 2017)

We share here the annual report written by our SIT for the Roman Project. The original version of this report was submitted to the Roman Project Office on July 14, 2017. Some minor updates have been made in this version. We note that this document does not constitute an official Roman Project document and is only for information purpose. In particular, the requirements below reflect a snapshot of the requirements formulation. The official Science Requirements Document (SRD) will always supersede the requirements written here.

Roman SIT "Cosmology with the High Latitude Survey" 2017 report [Report](/wfirst_sit_hls_cosmology_annual_report_april17.pdf).

---
---
## FIRST Roman [OIII] Emission Line Galaxy Mock Catalog

### [Roman [OIII] emitters mock catalog](https://sites.google.com/site/catalogswfirst/)
...
## LSST+ Roman Simulated Photometric Catalogs (*Peter Capak, Shoubaneh Hemmati, Dan Masters*, last updated on 08/02/17).

### [Roman+LSST simulated photometry catalog based on CANDELS, COSMOS, SXDS and VVDS](https://www.dropbox.com/s/tgfkrpotjyjfe16/WFIRST_sim_3.8sqdeg_v0.0.fits?dl=0).
...
### [Roman+LSST simulated photometry catalog based on CANDELS](https://www.dropbox.com/s/8m5fv5gn26ghp4i/WFIRST_CANDELSbased_sim_0.2sqdeg_v0.0.fits?dl=0).
...
### Roman modified gravity studies
