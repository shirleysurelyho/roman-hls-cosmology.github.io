...
## LSST+ WFIRST Simulated Photometric Catalogs (__Peter Capak, Shoubaneh Hemmati, Dan Masters__).
...
![](https://github.com/xoubish/Plots/blob/master/g-r.png)

Here are the magnitude histograms, a color-color plot and magnitude error vs. magnitude plots from this catalog.

![](https://github.com/xoubish/Plots/blob/master/magdist.png)
![](https://github.com/xoubish/Plots/blob/master/col-col.png)
![](https://github.com/xoubish/Plots/blob/master/magerr.png)
